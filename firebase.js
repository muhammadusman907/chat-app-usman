...
// ==============================================================================
// =================================== fire store =============================== 
import { getFirestore, collection, addDoc, doc, onSnapshot, setDoc, getDoc , updateDoc, query, where , getDocs ,serverTimestamp,orderBy } from "https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js";
// ================================  STORAGE
...
export {
    ...
    query, where,
    getStorage, storage, ref, uploadBytesResumable, getDownloadURL, getDocs,serverTimestamp,orderBy
}